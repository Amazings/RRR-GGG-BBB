...
Shader "VacuumShaders/Fragmentum/Demo/Car Transparent"
{
	Properties 
	{
		[HideInInspector]
	...
	SubShader   
	{
		Tags { "RenderType"="Transparent" "RenderType"="Transparent" "FragmentumTag"="Fragmentum/SM3/Unity Surface Shader/Transparent"}
		LOD 200 
