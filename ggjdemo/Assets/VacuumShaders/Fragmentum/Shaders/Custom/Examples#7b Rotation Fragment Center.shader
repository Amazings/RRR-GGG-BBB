...
Shader "VacuumShaders/Fragmentum/Examples/7b Rotation Fragment Center"
{
    Properties     
    {   
		[HideInInspector]
...
#define V_FR_ROTATE_FRAGMENT_CENTER
#define V_FR_ROTATE_AFTER_DISPLACE
#define V_FR_RANDOMIZE_ROTATION_SPEED
